        ...
        <div className="flex flex-col my-3">
            <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div className="flex justify-center items-center flex-col py-2">
                    <h1 className="font-logo text-gray-800 text-3xl font-semibold">Admin Dashboard</h1>
                                        ...
                                        <tbody>
                                                ...
                                                <tr className="bg-white border-b font-primary text-sm grid grid-cols-1 lg:grid-cols-6 place-items-center" key={_id}>
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                            <img className="w-48 lg:w-24 rounded-lg" src={bookings.img} alt={bookings.name} />
                                                    </td>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap flex flex-col h-24 items-center justify-center">
                                                        <div className="flex items-center justify-center space-x-3">
                                                            <AiOutlineDelete onClick={() => handleDelete(_id)} className="cursor-pointer text-2xl text-red-600" />
                                                                <button disabled={disabled} className="bg-green-500  px-4 py-2 text-white font-primary rounded-lg text-sm ring-blue-300 focus:ring-4 transition duration-300" onClick={() => handleApprove(_id)}>{data.status === "Approved" ? "Approved":"Approve"}</button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ))}
